...
public class PdsmanagementLocalApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		//stateAvailabilityRepository.save(new StateAvailability("60c4cff45e55143acc400608", availabilityList));
		//orderRequestrRepository.save(new OrderRequest("60c4cff45e55143acc400608", "60c4d1bb5e55143acc400612", 3478.08, "KG", true, new Date(), new Date()));
		//orderGrantRepository.save(new OrderGrant("60c4cff45e55143acc4005f5", "60c4d7deac9709541d7ef152", 3200.00, new Date(), new Date()));
	}
